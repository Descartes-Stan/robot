...
class DataUtil(Dataset):
    def __init__(self, config):
        ...
        if self.run_type == "train":
            self.train_data_list, self.validate_data_list, self.vocab_data_list = self.convert_util.gen_train_data()
    ...
    def __getitem__(self, index):
        if self.run_type == "train":
            ...
            return self.validate_data_list[0][index], self.validate_data_list[1][index], self.validate_data_list[index]
        else:
